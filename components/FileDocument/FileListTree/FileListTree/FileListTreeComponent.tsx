...
export interface IFileListTreeProps {
  value: string;
}
...
export const FileListTreeComponent: React.FC<IFileListTreeProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Hierarchical file/folder tree view</Caption1>}
          />
