...
export interface IExportWizardProps {
  value: string;
}
...
export const ExportWizardComponent: React.FC<IExportWizardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Multi-format export wizard (CSV, Excel, PDF, JSON)</Caption1>}
          />
