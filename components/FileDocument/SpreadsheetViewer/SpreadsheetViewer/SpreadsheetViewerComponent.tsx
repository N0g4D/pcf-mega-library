...
export const SpreadsheetViewerComponent: React.FC<ISpreadsheetViewerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Read-only spreadsheet viewer with freeze panes</Caption1>}
          />
