...
export interface IFileConflictProps {
  value: string;
}
...
export const FileConflictComponent: React.FC<IFileConflictProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>File version conflict resolution dialog</Caption1>}
          />
