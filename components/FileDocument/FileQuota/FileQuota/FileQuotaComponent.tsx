...
export interface IFileQuotaProps {
  value: string;
}
...
export const FileQuotaComponent: React.FC<IFileQuotaProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Per-user file storage quota display</Caption1>}
          />
