...
export const DownloadButtonComponent: React.FC<IDownloadButtonProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Download button with format selection and progress</Caption1>}
          />
