...
export interface IFileSharingProps {
  value: string;
}
...
export const FileSharingComponent: React.FC<IFileSharingProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>File sharing permissions panel</Caption1>}
          />
