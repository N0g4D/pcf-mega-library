...
export interface IBulkRenameProps {
  value: string;
}
...
export const BulkRenameComponent: React.FC<IBulkRenameProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Bulk file rename tool with pattern</Caption1>}
          />
