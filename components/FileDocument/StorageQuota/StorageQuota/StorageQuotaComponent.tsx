...
export interface IStorageQuotaProps {
  value: string;
}
...
export const StorageQuotaComponent: React.FC<IStorageQuotaProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Storage usage indicator with quota breakdown</Caption1>}
          />
