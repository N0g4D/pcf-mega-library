...
export interface IFileActivityProps {
  value: string;
}
...
export const FileActivityComponent: React.FC<IFileActivityProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>File access/edit activity log</Caption1>}
          />
