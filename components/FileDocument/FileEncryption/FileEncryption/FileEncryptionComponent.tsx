...
export interface IFileEncryptionProps {
  value: string;
}
...
export const FileEncryptionComponent: React.FC<IFileEncryptionProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>File encryption status indicator</Caption1>}
          />
