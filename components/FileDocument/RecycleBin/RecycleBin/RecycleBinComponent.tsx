...
export interface IRecycleBinProps {
  value: string;
}
...
export const RecycleBinComponent: React.FC<IRecycleBinProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Recycle bin / recently deleted files list</Caption1>}
          />
