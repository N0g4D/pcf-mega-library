...
export interface IFileCompressionProps {
  value: string;
}
...
export const FileCompressionComponent: React.FC<IFileCompressionProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>File compression status with progress</Caption1>}
          />
