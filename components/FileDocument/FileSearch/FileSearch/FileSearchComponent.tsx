...
export interface IFileSearchProps {
  value: string;
}
...
export const FileSearchComponent: React.FC<IFileSearchProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>File search with content preview</Caption1>}
          />
