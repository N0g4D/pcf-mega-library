...
export interface IAIEvaluationProps {
  value: string;
}
...
export const AIEvaluationComponent: React.FC<IAIEvaluationProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI response evaluation panel with metrics</Caption1>}
          />
