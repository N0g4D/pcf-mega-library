...
export interface IAIPromptChainProps {
  value: string;
}
...
export const AIPromptChainComponent: React.FC<IAIPromptChainProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Visual prompt chain/flow builder</Caption1>}
          />
