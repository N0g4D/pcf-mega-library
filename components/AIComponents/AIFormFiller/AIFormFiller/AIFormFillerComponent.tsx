...
export interface IAIFormFillerProps {
  value: string;
}
...
export const AIFormFillerComponent: React.FC<IAIFormFillerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI-assisted form auto-fill with review step</Caption1>}
          />
