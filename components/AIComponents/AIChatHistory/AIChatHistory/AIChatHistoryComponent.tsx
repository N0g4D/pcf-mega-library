...
export interface IAIChatHistoryProps {
  value: string;
}
...
export const AIChatHistoryComponent: React.FC<IAIChatHistoryProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI chat session history browser</Caption1>}
          />
