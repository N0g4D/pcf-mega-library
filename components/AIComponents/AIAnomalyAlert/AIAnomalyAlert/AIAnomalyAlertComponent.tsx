...
export interface IAIAnomalyAlertProps {
  value: string;
}
...
export const AIAnomalyAlertComponent: React.FC<IAIAnomalyAlertProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI anomaly detection alert card</Caption1>}
          />
