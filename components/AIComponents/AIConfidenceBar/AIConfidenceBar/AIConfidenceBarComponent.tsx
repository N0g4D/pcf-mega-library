...
export interface IAIConfidenceBarProps {
  value: string;
}
...
export const AIConfidenceBarComponent: React.FC<IAIConfidenceBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Confidence score visualization bar</Caption1>}
          />
