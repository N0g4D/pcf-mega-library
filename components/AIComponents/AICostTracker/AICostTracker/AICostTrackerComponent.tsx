...
export interface IAICostTrackerProps {
  value: string;
}
...
export const AICostTrackerComponent: React.FC<IAICostTrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI API cost/usage tracking display</Caption1>}
          />
