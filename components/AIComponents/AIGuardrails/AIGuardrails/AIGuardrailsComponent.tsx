...
export interface IAIGuardrailsProps {
  value: string;
}
...
export const AIGuardrailsComponent: React.FC<IAIGuardrailsProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI guardrail configuration and status display</Caption1>}
          />
