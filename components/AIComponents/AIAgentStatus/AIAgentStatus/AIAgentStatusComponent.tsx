...
export interface IAIAgentStatusProps {
  value: string;
}
...
export const AIAgentStatusComponent: React.FC<IAIAgentStatusProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI agent execution status timeline</Caption1>}
          />
