...
export interface IAIAutoCompleteProps {
  value: string;
}
...
export const AIAutoCompleteComponent: React.FC<IAIAutoCompleteProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI-powered autocomplete suggestion overlay</Caption1>}
          />
