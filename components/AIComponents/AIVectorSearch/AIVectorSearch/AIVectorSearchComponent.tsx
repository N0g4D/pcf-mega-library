...
export interface IAIVectorSearchProps {
  value: string;
}
...
export const AIVectorSearchComponent: React.FC<IAIVectorSearchProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Vector similarity search results display</Caption1>}
          />
