...
export const CopilotChatComponent: React.FC<ICopilotChatProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Copilot-style chat interface with message bubbles and typing indicator</Caption1>}
          />
