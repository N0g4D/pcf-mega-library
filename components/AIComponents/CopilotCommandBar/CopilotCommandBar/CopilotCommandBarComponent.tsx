...
export const CopilotCommandBarComponent: React.FC<ICopilotCommandBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI-enhanced command bar with natural language input</Caption1>}
          />
