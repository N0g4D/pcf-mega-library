...
export const AIInsightsPanelComponent: React.FC<IAIInsightsPanelProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>AI-generated insights panel with actionable recommendations</Caption1>}
          />
