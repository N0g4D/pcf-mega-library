...
export interface IRouteOptimizerProps {
  value: string;
}
...
export const RouteOptimizerComponent: React.FC<IRouteOptimizerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Multi-stop route optimization display</Caption1>}
          />
