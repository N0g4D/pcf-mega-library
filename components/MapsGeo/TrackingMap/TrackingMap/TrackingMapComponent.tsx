...
export interface ITrackingMapProps {
  value: string;
}
...
export const TrackingMapComponent: React.FC<ITrackingMapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Real-time asset/vehicle tracking map</Caption1>}
          />
