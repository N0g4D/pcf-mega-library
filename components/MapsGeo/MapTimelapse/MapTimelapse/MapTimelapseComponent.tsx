...
export interface IMapTimelapseProps {
  value: string;
}
...
export const MapTimelapseComponent: React.FC<IMapTimelapseProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Time-lapse animation of geographic data</Caption1>}
          />
