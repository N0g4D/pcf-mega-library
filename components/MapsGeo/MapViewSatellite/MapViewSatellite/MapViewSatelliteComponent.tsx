...
export interface IMapViewSatelliteProps {
  value: string;
}
...
export const MapViewSatelliteComponent: React.FC<IMapViewSatelliteProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Satellite imagery map view toggle</Caption1>}
          />
