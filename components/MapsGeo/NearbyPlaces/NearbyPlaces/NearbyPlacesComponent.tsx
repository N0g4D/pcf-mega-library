...
export interface INearbyPlacesProps {
  value: string;
}
...
export const NearbyPlacesComponent: React.FC<INearbyPlacesProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Nearby places list with distance</Caption1>}
          />
