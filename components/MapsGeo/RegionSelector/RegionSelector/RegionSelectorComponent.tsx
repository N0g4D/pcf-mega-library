...
export const RegionSelectorComponent: React.FC<IRegionSelectorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Country/state/region selector with map highlight</Caption1>}
          />
