...
export interface IMapViewIndoorProps {
  value: string;
}
...
export const MapViewIndoorComponent: React.FC<IMapViewIndoorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Indoor map with floor level switcher</Caption1>}
          />
