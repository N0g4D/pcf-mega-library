...
export interface IElevationProfileProps {
  value: string;
}
...
export const ElevationProfileComponent: React.FC<IElevationProfileProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Elevation profile chart for routes</Caption1>}
          />
