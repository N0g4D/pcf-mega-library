...
export interface IWeatherMapProps {
  value: string;
}
...
export const WeatherMapComponent: React.FC<IWeatherMapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Weather overlay on geographic map</Caption1>}
          />
