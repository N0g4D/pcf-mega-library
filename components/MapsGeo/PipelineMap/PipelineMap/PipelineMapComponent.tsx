...
export interface IPipelineMapProps {
  value: string;
}
...
export const PipelineMapComponent: React.FC<IPipelineMapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Pipeline/network infrastructure map</Caption1>}
          />
