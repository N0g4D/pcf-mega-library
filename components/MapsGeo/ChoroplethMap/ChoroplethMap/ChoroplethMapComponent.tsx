...
export interface IChoroplethMapProps {
  value: string;
}
...
export const ChoroplethMapComponent: React.FC<IChoroplethMapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Choropleth/thematic map by region</Caption1>}
          />
