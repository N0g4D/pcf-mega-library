...
export interface IMapViewHeatProps {
  value: string;
}
...
export const MapViewHeatComponent: React.FC<IMapViewHeatProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Heat map overlay on geographic map</Caption1>}
          />
