...
export interface IMapViewDrawingProps {
  value: string;
}
...
export const MapViewDrawingComponent: React.FC<IMapViewDrawingProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Map with polygon/line drawing tools</Caption1>}
          />
