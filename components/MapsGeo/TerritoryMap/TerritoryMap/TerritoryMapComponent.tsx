...
export interface ITerritoryMapProps {
  value: string;
}
...
export const TerritoryMapComponent: React.FC<ITerritoryMapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Sales territory map with boundaries</Caption1>}
          />
