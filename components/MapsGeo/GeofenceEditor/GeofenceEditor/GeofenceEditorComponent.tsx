...
export interface IGeofenceEditorProps {
  value: string;
}
...
export const GeofenceEditorComponent: React.FC<IGeofenceEditorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Geofence area editor on map</Caption1>}
          />
