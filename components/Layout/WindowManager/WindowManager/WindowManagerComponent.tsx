...
export const WindowManagerComponent: React.FC<IWindowManagerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Windowed MDI container with minimize/maximize/close</Caption1>}
          />
