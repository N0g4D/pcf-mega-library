...
export interface IModalDialogFullscreenProps {
  value: string;
}
...
export const ModalDialogFullscreenComponent: React.FC<IModalDialogFullscreenProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Fullscreen modal with transition animation</Caption1>}
          />
