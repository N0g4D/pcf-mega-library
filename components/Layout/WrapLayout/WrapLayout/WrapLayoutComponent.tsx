...
export interface IWrapLayoutProps {
  value: string;
}
...
export const WrapLayoutComponent: React.FC<IWrapLayoutProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Flex-wrap layout with consistent gap</Caption1>}
          />
