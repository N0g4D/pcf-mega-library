...
export interface ITooltipRichProps {
  value: string;
}
...
export const TooltipRichComponent: React.FC<ITooltipRichProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Tooltip with formatted content, links, and media</Caption1>}
          />
