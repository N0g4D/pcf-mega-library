...
export const DashboardGridComponent: React.FC<IDashboardGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Drag-and-drop dashboard grid with resizable widgets</Caption1>}
          />
