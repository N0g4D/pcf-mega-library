...
export const StickyHeaderComponent: React.FC<IStickyHeaderProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Header that sticks to top on scroll with shadow transition</Caption1>}
          />
