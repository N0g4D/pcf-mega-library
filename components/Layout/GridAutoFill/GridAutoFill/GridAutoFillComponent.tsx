...
export interface IGridAutoFillProps {
  value: string;
}
...
export const GridAutoFillComponent: React.FC<IGridAutoFillProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Auto-fill CSS grid that sizes columns to content</Caption1>}
          />
