...
export interface ISplitPaneTripleProps {
  value: string;
}
...
export const SplitPaneTripleComponent: React.FC<ISplitPaneTripleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Three-pane resizable layout</Caption1>}
          />
