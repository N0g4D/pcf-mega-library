...
export const ScrollContainerComponent: React.FC<IScrollContainerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Custom scrollbar-styled container with scroll shadows</Caption1>}
          />
