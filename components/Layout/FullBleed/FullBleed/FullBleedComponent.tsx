...
export interface IFullBleedProps {
  value: string;
}
...
export const FullBleedComponent: React.FC<IFullBleedProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full viewport width/height layout</Caption1>}
          />
