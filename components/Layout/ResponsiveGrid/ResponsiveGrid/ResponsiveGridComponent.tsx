...
export const ResponsiveGridComponent: React.FC<IResponsiveGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>CSS Grid-based responsive layout with configurable breakpoints</Caption1>}
          />
