...
export const FlexLayoutComponent: React.FC<IFlexLayoutProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Flexbox layout container with gap, wrap, and alignment props</Caption1>}
          />
