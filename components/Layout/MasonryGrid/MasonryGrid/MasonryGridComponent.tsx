...
export const MasonryGridComponent: React.FC<IMasonryGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Pinterest-style masonry grid with dynamic column count</Caption1>}
          />
