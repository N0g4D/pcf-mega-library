...
export const ContentSwitcherComponent: React.FC<IContentSwitcherProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Animated content area that transitions between children</Caption1>}
          />
