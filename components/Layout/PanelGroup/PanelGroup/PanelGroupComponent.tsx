...
export interface IPanelGroupProps {
  value: string;
}
...
export const PanelGroupComponent: React.FC<IPanelGroupProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Resizable panel group with constraints</Caption1>}
          />
