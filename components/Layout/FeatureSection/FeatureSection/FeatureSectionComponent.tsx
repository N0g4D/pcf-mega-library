...
export const FeatureSectionComponent: React.FC<IFeatureSectionProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Feature showcase section with icons and descriptions</Caption1>}
          />
