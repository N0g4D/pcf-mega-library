...
export const CollapseGroupComponent: React.FC<ICollapseGroupProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Group of collapsible regions with coordinated state</Caption1>}
          />
