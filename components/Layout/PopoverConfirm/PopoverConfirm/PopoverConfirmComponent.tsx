...
export interface IPopoverConfirmProps {
  value: string;
}
...
export const PopoverConfirmComponent: React.FC<IPopoverConfirmProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Popover with confirm/cancel action buttons</Caption1>}
          />
