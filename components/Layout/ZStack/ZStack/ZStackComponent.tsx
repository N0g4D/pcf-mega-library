...
export const ZStackComponent: React.FC<IZStackProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Layered/overlapping stack layout with z-index control</Caption1>}
          />
