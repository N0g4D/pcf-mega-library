...
export interface IAgendaWidgetProps {
  value: string;
}
...
export const AgendaWidgetComponent: React.FC<IAgendaWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Compact agenda widget for today/this week</Caption1>}
          />
