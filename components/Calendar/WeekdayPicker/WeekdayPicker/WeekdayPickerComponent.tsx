...
export interface IWeekdayPickerProps {
  value: string;
}
...
export const WeekdayPickerComponent: React.FC<IWeekdayPickerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Weekday multi-select picker</Caption1>}
          />
