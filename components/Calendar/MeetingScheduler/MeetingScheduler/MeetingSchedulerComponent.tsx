...
export const MeetingSchedulerComponent: React.FC<IMeetingSchedulerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Meeting time finder across multiple calendars</Caption1>}
          />
