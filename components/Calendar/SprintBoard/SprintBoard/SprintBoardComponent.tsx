...
export interface ISprintBoardProps {
  value: string;
}
...
export const SprintBoardComponent: React.FC<ISprintBoardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Sprint/iteration board with date tracking</Caption1>}
          />
