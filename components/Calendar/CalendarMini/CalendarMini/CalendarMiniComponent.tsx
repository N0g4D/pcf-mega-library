...
export interface ICalendarMiniProps {
  value: string;
}
...
export const CalendarMiniComponent: React.FC<ICalendarMiniProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Compact mini calendar for date selection</Caption1>}
          />
