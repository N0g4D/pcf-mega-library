...
export interface IDateNavigatorProps {
  value: string;
}
...
export const DateNavigatorComponent: React.FC<IDateNavigatorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Month/week/day date navigator control</Caption1>}
          />
