...
export interface ICalendarSyncProps {
  value: string;
}
...
export const CalendarSyncComponent: React.FC<ICalendarSyncProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Calendar sync status with external providers</Caption1>}
          />
