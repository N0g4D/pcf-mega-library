...
export interface ISchedulerGridProps {
  value: string;
}
...
export const SchedulerGridComponent: React.FC<ISchedulerGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Resource scheduler grid (rooms, people, assets)</Caption1>}
          />
