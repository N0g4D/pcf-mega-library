...
export interface ISchedulerTimelineProps {
  value: string;
}
...
export const SchedulerTimelineComponent: React.FC<ISchedulerTimelineProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Horizontal timeline scheduler</Caption1>}
          />
