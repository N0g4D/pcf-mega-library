...
export interface IShiftSchedulerProps {
  value: string;
}
...
export const ShiftSchedulerComponent: React.FC<IShiftSchedulerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Employee shift scheduling grid</Caption1>}
          />
