...
export interface ILoyaltyPointsProps {
  value: string;
}
...
export const LoyaltyPointsComponent: React.FC<ILoyaltyPointsProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Loyalty points balance and earn display</Caption1>}
          />
