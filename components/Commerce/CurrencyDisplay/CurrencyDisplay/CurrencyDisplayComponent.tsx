...
export const CurrencyDisplayComponent: React.FC<ICurrencyDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Formatted currency display with locale support</Caption1>}
          />
