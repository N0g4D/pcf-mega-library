...
export interface IGiftCardInputProps {
  value: string;
}
...
export const GiftCardInputComponent: React.FC<IGiftCardInputProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Gift card number input with balance check</Caption1>}
          />
