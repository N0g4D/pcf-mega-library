...
export const PaymentMethodSelectorComponent: React.FC<IPaymentMethodSelectorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Payment method selector with card icons</Caption1>}
          />
