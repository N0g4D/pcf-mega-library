...
export const QuantitySelectorComponent: React.FC<IQuantitySelectorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Product quantity selector with min/max limits</Caption1>}
          />
