...
export interface IDeliveryEstimateProps {
  value: string;
}
...
export const DeliveryEstimateComponent: React.FC<IDeliveryEstimateProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Delivery date estimate display</Caption1>}
          />
