...
export interface ICartSummaryMiniProps {
  value: string;
}
...
export const CartSummaryMiniComponent: React.FC<ICartSummaryMiniProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Mini cart summary popup</Caption1>}
          />
