...
export interface ICostBreakdownProps {
  value: string;
}
...
export const CostBreakdownComponent: React.FC<ICostBreakdownProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Cost breakdown donut with drill-down</Caption1>}
          />
