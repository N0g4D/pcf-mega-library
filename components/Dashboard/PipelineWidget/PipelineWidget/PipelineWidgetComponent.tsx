...
export interface IPipelineWidgetProps {
  value: string;
}
...
export const PipelineWidgetComponent: React.FC<IPipelineWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Deal/pipeline stages widget</Caption1>}
          />
