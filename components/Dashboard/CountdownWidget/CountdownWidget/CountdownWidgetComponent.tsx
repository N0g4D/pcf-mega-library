...
export interface ICountdownWidgetProps {
  value: string;
}
...
export const CountdownWidgetComponent: React.FC<ICountdownWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Countdown widget for deadlines/events</Caption1>}
          />
