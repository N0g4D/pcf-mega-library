...
export interface IABTestWidgetProps {
  value: string;
}
...
export const ABTestWidgetComponent: React.FC<IABTestWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>A/B test results comparison widget</Caption1>}
          />
