...
export interface IBudgetWidgetProps {
  value: string;
}
...
export const BudgetWidgetComponent: React.FC<IBudgetWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Budget vs actual spending widget</Caption1>}
          />
