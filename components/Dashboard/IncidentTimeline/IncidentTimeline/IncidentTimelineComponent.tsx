...
export const IncidentTimelineComponent: React.FC<IIncidentTimelineProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Incident timeline with severity and resolution</Caption1>}
          />
