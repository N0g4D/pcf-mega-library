...
export interface IResourceUsageProps {
  value: string;
}
...
export const ResourceUsageComponent: React.FC<IResourceUsageProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Resource utilization bar chart widget</Caption1>}
          />
