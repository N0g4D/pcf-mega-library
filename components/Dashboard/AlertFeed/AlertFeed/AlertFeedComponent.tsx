...
export interface IAlertFeedProps {
  value: string;
}
...
export const AlertFeedComponent: React.FC<IAlertFeedProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Alert/incident feed widget with severity</Caption1>}
          />
