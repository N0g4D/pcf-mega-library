...
export interface IQuickLinksWidgetProps {
  value: string;
}
...
export const QuickLinksWidgetComponent: React.FC<IQuickLinksWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Quick links/bookmarks widget grid</Caption1>}
          />
