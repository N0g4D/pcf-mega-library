...
export interface ITeamCapacityProps {
  value: string;
}
...
export const TeamCapacityComponent: React.FC<ITeamCapacityProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Team capacity/workload distribution widget</Caption1>}
          />
