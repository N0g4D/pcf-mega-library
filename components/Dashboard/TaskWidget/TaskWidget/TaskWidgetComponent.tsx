...
export interface ITaskWidgetProps {
  value: string;
}
...
export const TaskWidgetComponent: React.FC<ITaskWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Task/todo list widget with checkboxes</Caption1>}
          />
