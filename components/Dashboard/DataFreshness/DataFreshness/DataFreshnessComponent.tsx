...
export interface IDataFreshnessProps {
  value: string;
}
...
export const DataFreshnessComponent: React.FC<IDataFreshnessProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Data freshness/staleness indicator per source</Caption1>}
          />
