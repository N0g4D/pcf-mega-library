...
export interface IEmbedWidgetProps {
  value: string;
}
...
export const EmbedWidgetComponent: React.FC<IEmbedWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>iframe embed widget for external content</Caption1>}
          />
