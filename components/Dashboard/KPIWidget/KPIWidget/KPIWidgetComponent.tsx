...
export interface IKPIWidgetProps {
  value: string;
}
...
export const KPIWidgetComponent: React.FC<IKPIWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>KPI metric widget with trend and comparison</Caption1>}
          />
