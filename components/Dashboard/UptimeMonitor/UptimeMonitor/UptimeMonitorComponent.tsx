...
export interface IUptimeMonitorProps {
  value: string;
}
...
export const UptimeMonitorComponent: React.FC<IUptimeMonitorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Service uptime status indicator widget</Caption1>}
          />
