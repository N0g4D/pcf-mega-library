...
export interface ISLATrackerProps {
  value: string;
}
...
export const SLATrackerComponent: React.FC<ISLATrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>SLA compliance tracker with thresholds</Caption1>}
          />
