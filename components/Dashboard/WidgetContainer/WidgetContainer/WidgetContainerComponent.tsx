...
export const WidgetContainerComponent: React.FC<IWidgetContainerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Configurable widget container with resize and move</Caption1>}
          />
