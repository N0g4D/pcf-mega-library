...
export const DashboardShellComponent: React.FC<IDashboardShellProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full dashboard layout shell with sidebar and header</Caption1>}
          />
