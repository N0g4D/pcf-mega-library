...
export interface IShimmerEffectProps {
  value: string;
}
...
export const ShimmerEffectComponent: React.FC<IShimmerEffectProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Shimmer/shine loading animation overlay</Caption1>}
          />
