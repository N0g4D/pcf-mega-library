...
export interface ISyncIndicatorProps {
  value: string;
}
...
export const SyncIndicatorComponent: React.FC<ISyncIndicatorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Data sync progress indicator with timestamp</Caption1>}
          />
