...
export const NotificationBellComponent: React.FC<INotificationBellProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Notification bell icon with badge and dropdown list</Caption1>}
          />
