...
export interface ILiveIndicatorProps {
  value: string;
}
...
export const LiveIndicatorComponent: React.FC<ILiveIndicatorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Pulsing live/recording indicator</Caption1>}
          />
