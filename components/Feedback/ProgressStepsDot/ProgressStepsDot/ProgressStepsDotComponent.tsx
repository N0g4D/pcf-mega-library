...
export interface IProgressStepsDotProps {
  value: string;
}
...
export const ProgressStepsDotComponent: React.FC<IProgressStepsDotProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Dot-style step progress indicator</Caption1>}
          />
