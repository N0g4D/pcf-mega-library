...
export interface IBetaBadgeProps {
  value: string;
}
...
export const BetaBadgeComponent: React.FC<IBetaBadgeProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Beta/preview feature indicator badge</Caption1>}
          />
