...
export interface IAlertInlineProps {
  value: string;
}
...
export const AlertInlineComponent: React.FC<IAlertInlineProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Inline alert message with severity levels</Caption1>}
          />
