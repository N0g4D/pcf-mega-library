...
export const NotificationCenterComponent: React.FC<INotificationCenterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full notification center panel with categories</Caption1>}
          />
