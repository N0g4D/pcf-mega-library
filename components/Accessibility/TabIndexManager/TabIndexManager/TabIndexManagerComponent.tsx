...
export interface ITabIndexManagerProps {
  value: string;
}
...
export const TabIndexManagerComponent: React.FC<ITabIndexManagerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Tab index management utility component</Caption1>}
          />
