...
export interface IA11yToolbarProps {
  value: string;
}
...
export const A11yToolbarComponent: React.FC<IA11yToolbarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Accessibility settings toolbar (font, contrast, motion)</Caption1>}
          />
