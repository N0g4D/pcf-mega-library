...
export interface ISimplifiedViewProps {
  value: string;
}
...
export const SimplifiedViewComponent: React.FC<ISimplifiedViewProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Simplified/essential content view toggle</Caption1>}
          />
