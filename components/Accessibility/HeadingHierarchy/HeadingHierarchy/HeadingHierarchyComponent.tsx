...
export interface IHeadingHierarchyProps {
  value: string;
}
...
export const HeadingHierarchyComponent: React.FC<IHeadingHierarchyProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Heading hierarchy validator display</Caption1>}
          />
