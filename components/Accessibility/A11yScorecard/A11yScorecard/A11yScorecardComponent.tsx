...
export interface IA11yScorecardProps {
  value: string;
}
...
export const A11yScorecardComponent: React.FC<IA11yScorecardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Accessibility compliance scorecard</Caption1>}
          />
