...
export interface ITextResizerProps {
  value: string;
}
...
export const TextResizerComponent: React.FC<ITextResizerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Dynamic text resizing control</Caption1>}
          />
