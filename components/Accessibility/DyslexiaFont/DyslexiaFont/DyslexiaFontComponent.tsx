...
export interface IDyslexiaFontProps {
  value: string;
}
...
export const DyslexiaFontComponent: React.FC<IDyslexiaFontProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Dyslexia-friendly font toggle</Caption1>}
          />
