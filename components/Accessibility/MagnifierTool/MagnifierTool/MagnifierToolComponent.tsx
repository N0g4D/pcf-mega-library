...
export interface IMagnifierToolProps {
  value: string;
}
...
export const MagnifierToolComponent: React.FC<IMagnifierToolProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Screen magnifier/zoom tool</Caption1>}
          />
