...
export interface IReadingGuideProps {
  value: string;
}
...
export const ReadingGuideComponent: React.FC<IReadingGuideProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Reading guide ruler overlay</Caption1>}
          />
