...
export interface IVoiceCommandProps {
  value: string;
}
...
export const VoiceCommandComponent: React.FC<IVoiceCommandProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Voice command listener with visual feedback</Caption1>}
          />
