...
export interface IALTTextEditorProps {
  value: string;
}
...
export const ALTTextEditorComponent: React.FC<IALTTextEditorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Image alt text editor with AI suggestion</Caption1>}
          />
