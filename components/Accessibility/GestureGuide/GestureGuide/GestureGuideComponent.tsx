...
export interface IGestureGuideProps {
  value: string;
}
...
export const GestureGuideComponent: React.FC<IGestureGuideProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Touch gesture guide overlay</Caption1>}
          />
