...
export interface IKeyboardNavProps {
  value: string;
}
...
export const KeyboardNavComponent: React.FC<IKeyboardNavProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Keyboard navigation helper with arrow key support</Caption1>}
          />
