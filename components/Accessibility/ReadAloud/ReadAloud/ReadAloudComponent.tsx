...
export interface IReadAloudProps {
  value: string;
}
...
export const ReadAloudComponent: React.FC<IReadAloudProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Read-aloud/text-to-speech button</Caption1>}
          />
