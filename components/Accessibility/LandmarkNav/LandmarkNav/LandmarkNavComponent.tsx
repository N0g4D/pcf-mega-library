...
export interface ILandmarkNavProps {
  value: string;
}
...
export const LandmarkNavComponent: React.FC<ILandmarkNavProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>ARIA landmark quick navigation</Caption1>}
          />
