...
export interface IEmojiDisplayProps {
  value: string;
}
...
export const EmojiDisplayComponent: React.FC<IEmojiDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Large emoji display with skin tone picker</Caption1>}
          />
