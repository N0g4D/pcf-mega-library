...
export interface IImageComparisonProps {
  value: string;
}
...
export const ImageComparisonComponent: React.FC<IImageComparisonProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Before/after image comparison slider</Caption1>}
          />
