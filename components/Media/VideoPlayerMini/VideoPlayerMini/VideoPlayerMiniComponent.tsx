...
export interface IVideoPlayerMiniProps {
  value: string;
}
...
export const VideoPlayerMiniComponent: React.FC<IVideoPlayerMiniProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Compact mini video player widget</Caption1>}
          />
