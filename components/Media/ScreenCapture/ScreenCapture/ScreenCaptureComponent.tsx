...
export interface IScreenCaptureProps {
  value: string;
}
...
export const ScreenCaptureComponent: React.FC<IScreenCaptureProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Screen/region capture widget</Caption1>}
          />
