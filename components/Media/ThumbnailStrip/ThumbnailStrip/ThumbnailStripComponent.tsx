...
export interface IThumbnailStripProps {
  value: string;
}
...
export const ThumbnailStripComponent: React.FC<IThumbnailStripProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Horizontal thumbnail filmstrip</Caption1>}
          />
