...
export interface IImageAnnotatorProps {
  value: string;
}
...
export const ImageAnnotatorComponent: React.FC<IImageAnnotatorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Image annotation tool with pins and notes</Caption1>}
          />
