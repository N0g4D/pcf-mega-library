...
export interface IScreenshotToolProps {
  value: string;
}
...
export const ScreenshotToolComponent: React.FC<IScreenshotToolProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Region screenshot capture tool</Caption1>}
          />
