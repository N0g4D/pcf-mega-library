...
export interface ISpriteAnimationProps {
  value: string;
}
...
export const SpriteAnimationComponent: React.FC<ISpriteAnimationProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Sprite sheet animation player</Caption1>}
          />
