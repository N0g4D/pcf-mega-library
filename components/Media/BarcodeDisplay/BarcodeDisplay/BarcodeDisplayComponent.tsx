...
export interface IBarcodeDisplayProps {
  value: string;
}
...
export const BarcodeDisplayComponent: React.FC<IBarcodeDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Barcode generator (Code128, EAN, UPC)</Caption1>}
          />
