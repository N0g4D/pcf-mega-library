...
export interface IModelViewer3DProps {
  value: string;
}
...
export const ModelViewer3DComponent: React.FC<IModelViewer3DProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>3D model viewer with rotate/zoom controls</Caption1>}
          />
