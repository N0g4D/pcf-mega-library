...
export interface IPDFAnnotatorProps {
  value: string;
}
...
export const PDFAnnotatorComponent: React.FC<IPDFAnnotatorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>PDF viewer with highlight and annotation tools</Caption1>}
          />
