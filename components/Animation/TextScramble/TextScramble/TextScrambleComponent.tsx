...
export interface ITextScrambleProps {
  value: string;
}
...
export const TextScrambleComponent: React.FC<ITextScrambleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Text scramble/decode animation effect</Caption1>}
          />
