...
export const ScrollRevealComponent: React.FC<IScrollRevealProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Reveal elements on scroll with intersection observer</Caption1>}
          />
