...
export const PageTransitionComponent: React.FC<IPageTransitionProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Page-level transition animations (slide, fade, zoom)</Caption1>}
          />
