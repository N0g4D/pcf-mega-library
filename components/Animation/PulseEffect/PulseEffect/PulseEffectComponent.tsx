...
export interface IPulseEffectProps {
  value: string;
}
...
export const PulseEffectComponent: React.FC<IPulseEffectProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Pulsing animation effect wrapper</Caption1>}
          />
