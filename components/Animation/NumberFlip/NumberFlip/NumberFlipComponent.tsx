...
export interface INumberFlipProps {
  value: string;
}
...
export const NumberFlipComponent: React.FC<INumberFlipProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Flip-clock style number animation</Caption1>}
          />
