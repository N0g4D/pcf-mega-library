...
export interface IFadeInStaggerProps {
  value: string;
}
...
export const FadeInStaggerComponent: React.FC<IFadeInStaggerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Staggered fade-in for child elements</Caption1>}
          />
