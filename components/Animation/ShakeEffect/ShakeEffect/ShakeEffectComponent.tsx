...
export interface IShakeEffectProps {
  value: string;
}
...
export const ShakeEffectComponent: React.FC<IShakeEffectProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Shake animation for error emphasis</Caption1>}
          />
