...
export interface ICountUpDecimalProps {
  value: string;
}
...
export const CountUpDecimalComponent: React.FC<ICountUpDecimalProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Animated decimal/currency counter</Caption1>}
          />
