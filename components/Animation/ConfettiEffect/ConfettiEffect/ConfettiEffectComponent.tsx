...
export interface IConfettiEffectProps {
  value: string;
}
...
export const ConfettiEffectComponent: React.FC<IConfettiEffectProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Confetti particle explosion animation</Caption1>}
          />
