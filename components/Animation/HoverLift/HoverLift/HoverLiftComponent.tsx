...
export interface IHoverLiftProps {
  value: string;
}
...
export const HoverLiftComponent: React.FC<IHoverLiftProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Lift/shadow animation on hover</Caption1>}
          />
