...
export interface IFadeInUpProps {
  value: string;
}
...
export const FadeInUpComponent: React.FC<IFadeInUpProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Fade-in with upward slide animation</Caption1>}
          />
