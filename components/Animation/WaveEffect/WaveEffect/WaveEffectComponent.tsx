...
export interface IWaveEffectProps {
  value: string;
}
...
export const WaveEffectComponent: React.FC<IWaveEffectProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Animated wave/liquid effect background</Caption1>}
          />
