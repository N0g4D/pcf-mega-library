...
export interface IScaleInProps {
  value: string;
}
...
export const ScaleInComponent: React.FC<IScaleInProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Scale-in animation with configurable origin</Caption1>}
          />
