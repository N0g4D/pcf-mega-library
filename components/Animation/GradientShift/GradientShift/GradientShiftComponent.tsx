...
export interface IGradientShiftProps {
  value: string;
}
...
export const GradientShiftComponent: React.FC<IGradientShiftProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Animated gradient background shift</Caption1>}
          />
