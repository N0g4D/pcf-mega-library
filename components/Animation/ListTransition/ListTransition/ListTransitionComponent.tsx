...
export interface IListTransitionProps {
  value: string;
}
...
export const ListTransitionComponent: React.FC<IListTransitionProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Animated list add/remove with reorder</Caption1>}
          />
