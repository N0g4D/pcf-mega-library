...
export interface ISkeletonPulseProps {
  value: string;
}
...
export const SkeletonPulseComponent: React.FC<ISkeletonPulseProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Skeleton loading pulse animation</Caption1>}
          />
