...
export interface IScrollParallaxProps {
  value: string;
}
...
export const ScrollParallaxComponent: React.FC<IScrollParallaxProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Parallax scrolling effect layer</Caption1>}
          />
