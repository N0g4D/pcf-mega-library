...
export interface IBounceEffectProps {
  value: string;
}
...
export const BounceEffectComponent: React.FC<IBounceEffectProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Bounce animation wrapper</Caption1>}
          />
