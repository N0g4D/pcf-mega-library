...
export interface ITypingUsersProps {
  value: string;
}
...
export const TypingUsersComponent: React.FC<ITypingUsersProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Users currently typing indicator</Caption1>}
          />
