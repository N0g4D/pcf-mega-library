...
export interface ISurveyWidgetProps {
  value: string;
}
...
export const SurveyWidgetComponent: React.FC<ISurveyWidgetProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Inline survey/poll widget</Caption1>}
          />
