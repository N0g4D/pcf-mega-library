...
export interface ICallLogProps {
  value: string;
}
...
export const CallLogComponent: React.FC<ICallLogProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Call log/history list with duration and type</Caption1>}
          />
