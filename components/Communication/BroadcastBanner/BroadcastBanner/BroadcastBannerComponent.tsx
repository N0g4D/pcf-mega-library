...
export interface IBroadcastBannerProps {
  value: string;
}
...
export const BroadcastBannerComponent: React.FC<IBroadcastBannerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>System broadcast message banner</Caption1>}
          />
