...
export interface ISignalRStatusProps {
  value: string;
}
...
export const SignalRStatusComponent: React.FC<ISignalRStatusProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Real-time connection status indicator</Caption1>}
          />
