...
export interface IThreadPanelProps {
  value: string;
}
...
export const ThreadPanelComponent: React.FC<IThreadPanelProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Thread/reply panel for messages</Caption1>}
          />
