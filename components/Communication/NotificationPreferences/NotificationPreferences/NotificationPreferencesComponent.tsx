...
export const NotificationPreferencesComponent: React.FC<INotificationPreferencesProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Notification channel preferences form</Caption1>}
          />
