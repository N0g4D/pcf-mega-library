...
export interface IRateLimitDisplayProps {
  value: string;
}
...
export const RateLimitDisplayComponent: React.FC<IRateLimitDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>API rate limit usage display</Caption1>}
          />
