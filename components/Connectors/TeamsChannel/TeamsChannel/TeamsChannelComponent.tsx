...
export interface ITeamsChannelProps {
  value: string;
}
...
export const TeamsChannelComponent: React.FC<ITeamsChannelProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Teams channel messages display widget</Caption1>}
          />
