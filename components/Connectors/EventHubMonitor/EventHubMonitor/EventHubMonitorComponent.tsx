...
export interface IEventHubMonitorProps {
  value: string;
}
...
export const EventHubMonitorComponent: React.FC<IEventHubMonitorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Event Hub message monitor widget</Caption1>}
          />
