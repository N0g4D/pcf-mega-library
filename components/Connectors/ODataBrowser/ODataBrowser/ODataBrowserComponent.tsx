...
export interface IODataBrowserProps {
  value: string;
}
...
export const ODataBrowserComponent: React.FC<IODataBrowserProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>OData entity browser with query builder</Caption1>}
          />
