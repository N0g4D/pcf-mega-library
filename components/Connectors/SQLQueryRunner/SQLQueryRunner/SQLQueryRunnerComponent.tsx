...
export interface ISQLQueryRunnerProps {
  value: string;
}
...
export const SQLQueryRunnerComponent: React.FC<ISQLQueryRunnerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>SQL query input and result table</Caption1>}
          />
