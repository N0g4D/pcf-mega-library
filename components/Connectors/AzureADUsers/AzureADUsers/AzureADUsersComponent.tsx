...
export interface IAzureADUsersProps {
  value: string;
}
...
export const AzureADUsersComponent: React.FC<IAzureADUsersProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Azure AD user directory browser</Caption1>}
          />
