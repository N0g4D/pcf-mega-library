...
export interface ICosmosDBExplorerProps {
  value: string;
}
...
export const CosmosDBExplorerComponent: React.FC<ICosmosDBExplorerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Cosmos DB document explorer</Caption1>}
          />
