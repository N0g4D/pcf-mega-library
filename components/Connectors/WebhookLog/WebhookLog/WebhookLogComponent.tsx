...
export interface IWebhookLogProps {
  value: string;
}
...
export const WebhookLogComponent: React.FC<IWebhookLogProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Webhook delivery log with payload inspection</Caption1>}
          />
