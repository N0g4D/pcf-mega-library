...
export const ConnectionManagerComponent: React.FC<IConnectionManagerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Multi-connection manager with health checks</Caption1>}
          />
