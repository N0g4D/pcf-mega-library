...
export interface ISharePointDocLibProps {
  value: string;
}
...
export const SharePointDocLibComponent: React.FC<ISharePointDocLibProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>SharePoint document library browser</Caption1>}
          />
