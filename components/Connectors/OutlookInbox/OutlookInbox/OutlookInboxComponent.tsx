...
export interface IOutlookInboxProps {
  value: string;
}
...
export const OutlookInboxComponent: React.FC<IOutlookInboxProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Outlook inbox summary widget</Caption1>}
          />
