...
export interface IOAuth2FlowProps {
  value: string;
}
...
export const OAuth2FlowComponent: React.FC<IOAuth2FlowProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>OAuth2 authorization flow display</Caption1>}
          />
