...
export interface IBMICalculatorProps {
  value: string;
}
...
export const BMICalculatorComponent: React.FC<IBMICalculatorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>BMI calculator with visual scale</Caption1>}
          />
