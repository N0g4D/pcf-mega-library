...
export interface IIrisScanDisplayProps {
  value: string;
}
...
export const IrisScanDisplayComponent: React.FC<IIrisScanDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Iris scan visualization display</Caption1>}
          />
