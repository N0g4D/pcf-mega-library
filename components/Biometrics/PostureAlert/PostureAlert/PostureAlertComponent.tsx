...
export interface IPostureAlertProps {
  value: string;
}
...
export const PostureAlertComponent: React.FC<IPostureAlertProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Posture monitoring alert indicator</Caption1>}
          />
