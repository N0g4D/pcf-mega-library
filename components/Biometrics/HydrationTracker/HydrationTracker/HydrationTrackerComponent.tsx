...
export interface IHydrationTrackerProps {
  value: string;
}
...
export const HydrationTrackerComponent: React.FC<IHydrationTrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Water intake tracker with daily goal</Caption1>}
          />
