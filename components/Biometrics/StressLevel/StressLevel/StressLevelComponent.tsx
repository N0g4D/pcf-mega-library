...
export interface IStressLevelProps {
  value: string;
}
...
export const StressLevelComponent: React.FC<IStressLevelProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Stress level indicator with breathing exercise</Caption1>}
          />
