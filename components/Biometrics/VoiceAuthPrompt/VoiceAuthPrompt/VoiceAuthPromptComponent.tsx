...
export interface IVoiceAuthPromptProps {
  value: string;
}
...
export const VoiceAuthPromptComponent: React.FC<IVoiceAuthPromptProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Voice authentication recording prompt</Caption1>}
          />
