...
export interface ISleepTrackerProps {
  value: string;
}
...
export const SleepTrackerComponent: React.FC<ISleepTrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Sleep quality visualization with phases</Caption1>}
          />
