...
export interface IMoodTrackerProps {
  value: string;
}
...
export const MoodTrackerComponent: React.FC<IMoodTrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Mood/emotion tracking input with emoji</Caption1>}
          />
