...
export interface IFocusTimerProps {
  value: string;
}
...
export const FocusTimerComponent: React.FC<IFocusTimerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Focus/pomodoro timer with break reminders</Caption1>}
          />
