...
export interface IFaceIDPromptProps {
  value: string;
}
...
export const FaceIDPromptComponent: React.FC<IFaceIDPromptProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Face ID authentication prompt with animation</Caption1>}
          />
