...
export interface IGlucoseMonitorProps {
  value: string;
}
...
export const GlucoseMonitorComponent: React.FC<IGlucoseMonitorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Blood glucose level monitor with range</Caption1>}
          />
