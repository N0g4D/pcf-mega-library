...
export interface ICalorieTrackerProps {
  value: string;
}
...
export const CalorieTrackerComponent: React.FC<ICalorieTrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Calorie intake/burn tracker ring</Caption1>}
          />
