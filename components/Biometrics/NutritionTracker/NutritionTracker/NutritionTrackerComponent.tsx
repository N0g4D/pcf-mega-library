...
export interface INutritionTrackerProps {
  value: string;
}
...
export const NutritionTrackerComponent: React.FC<INutritionTrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Macro/micro nutrient intake tracker</Caption1>}
          />
