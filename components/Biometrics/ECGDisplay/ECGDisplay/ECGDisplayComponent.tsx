...
export interface IECGDisplayProps {
  value: string;
}
...
export const ECGDisplayComponent: React.FC<IECGDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>ECG/EKG waveform display</Caption1>}
          />
