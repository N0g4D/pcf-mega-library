...
export interface IOxygenSaturationProps {
  value: string;
}
...
export const OxygenSaturationComponent: React.FC<IOxygenSaturationProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>SpO2 oxygen saturation display</Caption1>}
          />
