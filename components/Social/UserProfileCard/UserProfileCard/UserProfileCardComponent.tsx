...
export const UserProfileCardComponent: React.FC<IUserProfileCardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>User profile card with avatar, name, role, and stats</Caption1>}
          />
