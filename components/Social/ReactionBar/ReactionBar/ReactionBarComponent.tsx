...
export interface IReactionBarProps {
  value: string;
}
...
export const ReactionBarComponent: React.FC<IReactionBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Emoji reaction bar (like Facebook/Slack reactions)</Caption1>}
          />
