...
export const ShareButtonComponent: React.FC<IShareButtonProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Share button with platform options (email, copy link, social)</Caption1>}
          />
