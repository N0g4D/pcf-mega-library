...
export interface ISkillsBarProps {
  value: string;
}
...
export const SkillsBarComponent: React.FC<ISkillsBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Skills/expertise bar chart on profile</Caption1>}
          />
