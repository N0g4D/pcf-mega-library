...
export interface IUserProfileFullProps {
  value: string;
}
...
export const UserProfileFullComponent: React.FC<IUserProfileFullProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full user profile page component</Caption1>}
          />
