...
export interface IMentionBadgeProps {
  value: string;
}
...
export const MentionBadgeComponent: React.FC<IMentionBadgeProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Mention notification badge with user avatar</Caption1>}
          />
