...
export interface IHashtagListProps {
  value: string;
}
...
export const HashtagListComponent: React.FC<IHashtagListProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Trending hashtags list</Caption1>}
          />
