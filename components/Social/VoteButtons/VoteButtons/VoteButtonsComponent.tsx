...
export interface IVoteButtonsProps {
  value: string;
}
...
export const VoteButtonsComponent: React.FC<IVoteButtonsProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Upvote/downvote buttons with score</Caption1>}
          />
