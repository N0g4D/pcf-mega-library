...
export const NotificationItemComponent: React.FC<INotificationItemProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Single notification item with avatar and action</Caption1>}
          />
