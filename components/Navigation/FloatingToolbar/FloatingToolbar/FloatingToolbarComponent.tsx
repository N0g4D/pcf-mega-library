...
export const FloatingToolbarComponent: React.FC<IFloatingToolbarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Context-sensitive floating toolbar near selection</Caption1>}
          />
