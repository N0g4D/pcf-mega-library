...
export const BreadcrumbComponent: React.FC<IBreadcrumbProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Responsive breadcrumb trail with overflow menu and custom separators</Caption1>}
          />
