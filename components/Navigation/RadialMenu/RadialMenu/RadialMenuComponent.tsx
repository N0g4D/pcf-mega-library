...
export interface IRadialMenuProps {
  value: string;
}
...
export const RadialMenuComponent: React.FC<IRadialMenuProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Radial/pie context menu</Caption1>}
          />
