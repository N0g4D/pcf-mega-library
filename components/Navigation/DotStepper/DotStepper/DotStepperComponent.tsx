...
export interface IDotStepperProps {
  value: string;
}
...
export const DotStepperComponent: React.FC<IDotStepperProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Dot-based step indicator for onboarding flows</Caption1>}
          />
