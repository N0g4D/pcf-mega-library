...
export interface IBubbleNavProps {
  value: string;
}
...
export const BubbleNavComponent: React.FC<IBubbleNavProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Animated bubble/dot navigation for sections</Caption1>}
          />
