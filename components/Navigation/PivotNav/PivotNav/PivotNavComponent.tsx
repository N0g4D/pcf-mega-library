...
export interface IPivotNavProps {
  value: string;
}
...
export const PivotNavComponent: React.FC<IPivotNavProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Pivot-style navigation with animated underline indicator</Caption1>}
          />
