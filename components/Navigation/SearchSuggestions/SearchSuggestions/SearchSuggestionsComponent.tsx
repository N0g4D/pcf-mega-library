...
export const SearchSuggestionsComponent: React.FC<ISearchSuggestionsProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Search suggestions overlay with categories</Caption1>}
          />
