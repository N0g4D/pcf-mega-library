...
export const SideNavComponent: React.FC<ISideNavProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Collapsible side navigation panel with nested groups and active indicators</Caption1>}
          />
