...
export const CommandBarComponent: React.FC<ICommandBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Fluent UI command bar with search, overflow, and far items</Caption1>}
          />
