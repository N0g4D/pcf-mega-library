...
export const TabStripComponent: React.FC<ITabStripProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Horizontal tab strip with closable, draggable, and overflow tabs</Caption1>}
          />
