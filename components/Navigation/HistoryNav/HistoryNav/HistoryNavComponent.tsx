...
export interface IHistoryNavProps {
  value: string;
}
...
export const HistoryNavComponent: React.FC<IHistoryNavProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Back/forward navigation with history dropdown</Caption1>}
          />
