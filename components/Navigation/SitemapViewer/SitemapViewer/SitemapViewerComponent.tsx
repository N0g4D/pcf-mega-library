...
export interface ISitemapViewerProps {
  value: string;
}
...
export const SitemapViewerComponent: React.FC<ISitemapViewerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Visual sitemap viewer with clickable nodes</Caption1>}
          />
