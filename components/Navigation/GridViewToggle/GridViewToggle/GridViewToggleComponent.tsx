...
export interface IGridViewToggleProps {
  value: string;
}
...
export const GridViewToggleComponent: React.FC<IGridViewToggleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grid/list/table view mode toggle</Caption1>}
          />
