...
export interface ISideNavMiniProps {
  value: string;
}
...
export const SideNavMiniComponent: React.FC<ISideNavMiniProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Mini sidebar with icon tooltips and expand button</Caption1>}
          />
