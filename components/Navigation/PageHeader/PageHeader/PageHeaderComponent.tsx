...
export const PageHeaderComponent: React.FC<IPageHeaderProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Page header with title, subtitle, breadcrumb, and action buttons</Caption1>}
          />
