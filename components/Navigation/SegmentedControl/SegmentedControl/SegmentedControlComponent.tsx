...
export const SegmentedControlComponent: React.FC<ISegmentedControlProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>iOS-style segmented control for view switching</Caption1>}
          />
