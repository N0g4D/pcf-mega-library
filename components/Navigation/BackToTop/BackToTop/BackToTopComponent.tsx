...
export const BackToTopComponent: React.FC<IBackToTopProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Scroll-to-top button with smooth animation and progress ring</Caption1>}
          />
