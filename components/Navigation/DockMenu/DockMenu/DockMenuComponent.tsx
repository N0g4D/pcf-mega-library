...
export interface IDockMenuProps {
  value: string;
}
...
export const DockMenuComponent: React.FC<IDockMenuProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Bottom dock-style menu with active indicator</Caption1>}
          />
