...
export const SplitButtonComponent: React.FC<ISplitButtonProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Button with primary action and dropdown for alternatives</Caption1>}
          />
