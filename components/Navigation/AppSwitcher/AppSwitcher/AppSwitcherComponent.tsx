...
export const AppSwitcherComponent: React.FC<IAppSwitcherProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grid-style app switcher overlay (like Office waffle menu)</Caption1>}
          />
