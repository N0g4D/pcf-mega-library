...
export interface INavRailProps {
  value: string;
}
...
export const NavRailComponent: React.FC<INavRailProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Material-style navigation rail with labels and FAB</Caption1>}
          />
