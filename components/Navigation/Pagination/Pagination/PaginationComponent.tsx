...
export const PaginationComponent: React.FC<IPaginationProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Page navigation control with page size selector and jump-to-page</Caption1>}
          />
