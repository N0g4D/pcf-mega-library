...
export interface IGlassCalendarProps {
  value: string;
}
...
export const GlassCalendarComponent: React.FC<IGlassCalendarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled mini calendar</Caption1>}
          />
