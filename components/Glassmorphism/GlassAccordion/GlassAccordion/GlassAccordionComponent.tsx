...
export interface IGlassAccordionProps {
  value: string;
}
...
export const GlassAccordionComponent: React.FC<IGlassAccordionProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glassmorphism accordion panels</Caption1>}
          />
