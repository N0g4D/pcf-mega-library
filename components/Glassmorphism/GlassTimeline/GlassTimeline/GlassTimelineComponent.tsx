...
export interface IGlassTimelineProps {
  value: string;
}
...
export const GlassTimelineComponent: React.FC<IGlassTimelineProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass timeline component</Caption1>}
          />
