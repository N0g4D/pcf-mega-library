...
export interface IGlassDataCardProps {
  value: string;
}
...
export const GlassDataCardComponent: React.FC<IGlassDataCardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glassmorphism data/metric display card</Caption1>}
          />
