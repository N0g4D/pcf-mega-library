...
export interface IGlassLoginFormProps {
  value: string;
}
...
export const GlassLoginFormComponent: React.FC<IGlassLoginFormProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Complete login form with glass styling</Caption1>}
          />
