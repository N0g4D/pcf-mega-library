...
export interface IGlassTabsProps {
  value: string;
}
...
export const GlassTabsComponent: React.FC<IGlassTabsProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled tab navigation</Caption1>}
          />
