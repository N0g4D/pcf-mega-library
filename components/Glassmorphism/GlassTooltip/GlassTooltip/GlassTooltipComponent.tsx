...
export interface IGlassTooltipProps {
  value: string;
}
...
export const GlassTooltipComponent: React.FC<IGlassTooltipProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass tooltip</Caption1>}
          />
