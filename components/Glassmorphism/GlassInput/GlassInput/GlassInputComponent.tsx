...
export interface IGlassInputProps {
  value: string;
}
...
export const GlassInputComponent: React.FC<IGlassInputProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glassmorphism text input field</Caption1>}
          />
