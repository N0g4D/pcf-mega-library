...
export interface IGlassMediaCardProps {
  value: string;
}
...
export const GlassMediaCardComponent: React.FC<IGlassMediaCardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled media/video card</Caption1>}
          />
