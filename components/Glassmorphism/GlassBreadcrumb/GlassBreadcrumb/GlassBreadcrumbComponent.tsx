...
export interface IGlassBreadcrumbProps {
  value: string;
}
...
export const GlassBreadcrumbComponent: React.FC<IGlassBreadcrumbProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled breadcrumb navigation</Caption1>}
          />
