...
export interface IGlassChatBubbleProps {
  value: string;
}
...
export const GlassChatBubbleComponent: React.FC<IGlassChatBubbleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass chat message bubble</Caption1>}
          />
