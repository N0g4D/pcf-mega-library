...
export interface IGlassFooterProps {
  value: string;
}
...
export const GlassFooterComponent: React.FC<IGlassFooterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled page footer</Caption1>}
          />
