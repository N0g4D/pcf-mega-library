...
export interface IGlassNavBarProps {
  value: string;
}
...
export const GlassNavBarComponent: React.FC<IGlassNavBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Transparent glass navigation bar</Caption1>}
          />
