...
export interface IGlassSidebarProps {
  value: string;
}
...
export const GlassSidebarComponent: React.FC<IGlassSidebarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glassmorphic sidebar navigation</Caption1>}
          />
