...
export interface IGlassWidgetCardProps {
  value: string;
}
...
export const GlassWidgetCardComponent: React.FC<IGlassWidgetCardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled dashboard widget card</Caption1>}
          />
