...
export interface IGlassMenuProps {
  value: string;
}
...
export const GlassMenuComponent: React.FC<IGlassMenuProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass context/dropdown menu</Caption1>}
          />
