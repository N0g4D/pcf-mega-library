...
export interface IGlassCommandBarProps {
  value: string;
}
...
export const GlassCommandBarComponent: React.FC<IGlassCommandBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glassmorphism command bar</Caption1>}
          />
