...
export interface IGlassModalProps {
  value: string;
}
...
export const GlassModalComponent: React.FC<IGlassModalProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass modal dialog</Caption1>}
          />
