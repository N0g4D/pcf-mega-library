...
export interface IGlassNotificationProps {
  value: string;
}
...
export const GlassNotificationComponent: React.FC<IGlassNotificationProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled notification popup</Caption1>}
          />
