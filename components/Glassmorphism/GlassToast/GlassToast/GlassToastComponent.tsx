...
export interface IGlassToastProps {
  value: string;
}
...
export const GlassToastComponent: React.FC<IGlassToastProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass toast notification</Caption1>}
          />
