...
export interface IGlassProgressProps {
  value: string;
}
...
export const GlassProgressComponent: React.FC<IGlassProgressProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled progress bar</Caption1>}
          />
