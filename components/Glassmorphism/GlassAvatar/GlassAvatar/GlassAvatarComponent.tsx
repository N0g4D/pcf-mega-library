...
export interface IGlassAvatarProps {
  value: string;
}
...
export const GlassAvatarComponent: React.FC<IGlassAvatarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass avatar frame</Caption1>}
          />
