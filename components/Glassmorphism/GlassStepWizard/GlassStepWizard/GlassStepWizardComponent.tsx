...
export interface IGlassStepWizardProps {
  value: string;
}
...
export const GlassStepWizardComponent: React.FC<IGlassStepWizardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled multi-step wizard</Caption1>}
          />
