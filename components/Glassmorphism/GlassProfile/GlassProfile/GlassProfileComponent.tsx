...
export interface IGlassProfileProps {
  value: string;
}
...
export const GlassProfileComponent: React.FC<IGlassProfileProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled profile card with avatar</Caption1>}
          />
