...
export interface IGlassStatsProps {
  value: string;
}
...
export const GlassStatsComponent: React.FC<IGlassStatsProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass stats/KPI display tiles</Caption1>}
          />
