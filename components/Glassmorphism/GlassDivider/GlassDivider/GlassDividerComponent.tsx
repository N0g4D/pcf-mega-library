...
export interface IGlassDividerProps {
  value: string;
}
...
export const GlassDividerComponent: React.FC<IGlassDividerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass divider with gradient</Caption1>}
          />
