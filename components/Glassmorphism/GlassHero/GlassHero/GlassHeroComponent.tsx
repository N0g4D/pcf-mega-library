...
export interface IGlassHeroProps {
  value: string;
}
...
export const GlassHeroComponent: React.FC<IGlassHeroProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full-width glass hero section with parallax</Caption1>}
          />
