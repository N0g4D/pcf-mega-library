...
export interface IGlassButtonProps {
  value: string;
}
...
export const GlassButtonComponent: React.FC<IGlassButtonProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Frosted glass button with hover effects</Caption1>}
          />
