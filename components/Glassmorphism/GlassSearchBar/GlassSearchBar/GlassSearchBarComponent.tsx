...
export interface IGlassSearchBarProps {
  value: string;
}
...
export const GlassSearchBarComponent: React.FC<IGlassSearchBarProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full-width glass search bar</Caption1>}
          />
