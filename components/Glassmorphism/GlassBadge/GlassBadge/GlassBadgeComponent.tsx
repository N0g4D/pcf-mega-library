...
export interface IGlassBadgeProps {
  value: string;
}
...
export const GlassBadgeComponent: React.FC<IGlassBadgeProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glassmorphism badge/tag component</Caption1>}
          />
