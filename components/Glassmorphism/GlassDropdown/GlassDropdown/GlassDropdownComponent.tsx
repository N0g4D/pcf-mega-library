...
export interface IGlassDropdownProps {
  value: string;
}
...
export const GlassDropdownComponent: React.FC<IGlassDropdownProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled dropdown menu</Caption1>}
          />
