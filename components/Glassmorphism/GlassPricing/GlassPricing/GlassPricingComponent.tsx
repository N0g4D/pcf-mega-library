...
export interface IGlassPricingProps {
  value: string;
}
...
export const GlassPricingComponent: React.FC<IGlassPricingProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Pricing table with glass card design</Caption1>}
          />
