...
export interface IGlassToggleProps {
  value: string;
}
...
export const GlassToggleComponent: React.FC<IGlassToggleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Glass-styled toggle switch</Caption1>}
          />
