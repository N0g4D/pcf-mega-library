...
export interface IThemeBuilderProps {
  value: string;
}
...
export const ThemeBuilderComponent: React.FC<IThemeBuilderProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Visual theme builder with live preview</Caption1>}
          />
