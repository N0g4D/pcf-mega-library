...
export interface IBrandingKitProps {
  value: string;
}
...
export const BrandingKitComponent: React.FC<IBrandingKitProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Brand assets display (logo, colors, fonts)</Caption1>}
          />
