...
export interface ITokenEditorProps {
  value: string;
}
...
export const TokenEditorComponent: React.FC<ITokenEditorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Design token editor with live preview</Caption1>}
          />
