...
export interface IThemeSwitcherSegmentedProps {
  value: string;
}
...
export const ThemeSwitcherSegmentedComponent: React.FC<IThemeSwitcherSegmentedProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Segmented control theme switcher</Caption1>}
          />
