...
export interface IContrastCheckerProps {
  value: string;
}
...
export const ContrastCheckerComponent: React.FC<IContrastCheckerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>WCAG contrast ratio checker tool</Caption1>}
          />
