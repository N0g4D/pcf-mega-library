...
export interface ILayoutDensityProps {
  value: string;
}
...
export const LayoutDensityComponent: React.FC<ILayoutDensityProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Compact/normal/spacious density toggle</Caption1>}
          />
