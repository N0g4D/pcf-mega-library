...
export interface ISpacingScaleProps {
  value: string;
}
...
export const SpacingScaleComponent: React.FC<ISpacingScaleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Spacing scale visual reference</Caption1>}
          />
