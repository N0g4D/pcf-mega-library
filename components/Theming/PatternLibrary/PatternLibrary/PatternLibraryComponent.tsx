...
export interface IPatternLibraryProps {
  value: string;
}
...
export const PatternLibraryComponent: React.FC<IPatternLibraryProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>UI pattern library browser</Caption1>}
          />
