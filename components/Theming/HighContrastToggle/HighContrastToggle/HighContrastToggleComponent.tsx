...
export interface IHighContrastToggleProps {
  value: string;
}
...
export const HighContrastToggleComponent: React.FC<IHighContrastToggleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>High contrast mode toggle</Caption1>}
          />
