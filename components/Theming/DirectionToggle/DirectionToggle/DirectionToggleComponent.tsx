...
export interface IDirectionToggleProps {
  value: string;
}
...
export const DirectionToggleComponent: React.FC<IDirectionToggleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>LTR/RTL direction toggle with icon</Caption1>}
          />
