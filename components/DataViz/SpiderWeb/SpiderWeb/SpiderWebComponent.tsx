...
export interface ISpiderWebProps {
  value: string;
}
...
export const SpiderWebComponent: React.FC<ISpiderWebProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Spider/web comparison chart</Caption1>}
          />
