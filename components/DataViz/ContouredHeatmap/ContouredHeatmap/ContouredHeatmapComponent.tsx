...
export interface IContouredHeatmapProps {
  value: string;
}
...
export const ContouredHeatmapComponent: React.FC<IContouredHeatmapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Contoured/density heat map</Caption1>}
          />
