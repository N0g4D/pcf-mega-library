...
export interface IStackedBarTimelineProps {
  value: string;
}
...
export const StackedBarTimelineComponent: React.FC<IStackedBarTimelineProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Stacked bar chart as timeline</Caption1>}
          />
