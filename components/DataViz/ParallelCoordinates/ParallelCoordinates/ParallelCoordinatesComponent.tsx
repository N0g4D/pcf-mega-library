...
export const ParallelCoordinatesComponent: React.FC<IParallelCoordinatesProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Parallel coordinates chart for multi-variable analysis</Caption1>}
          />
