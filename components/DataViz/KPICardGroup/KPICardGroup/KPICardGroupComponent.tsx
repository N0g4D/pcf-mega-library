...
export interface IKPICardGroupProps {
  value: string;
}
...
export const KPICardGroupComponent: React.FC<IKPICardGroupProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Group of KPI cards with responsive layout</Caption1>}
          />
