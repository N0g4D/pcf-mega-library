...
export interface IPictogramChartProps {
  value: string;
}
...
export const PictogramChartComponent: React.FC<IPictogramChartProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Pictogram/isotype chart with icons</Caption1>}
          />
