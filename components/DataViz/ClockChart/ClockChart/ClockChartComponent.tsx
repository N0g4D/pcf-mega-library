...
export interface IClockChartProps {
  value: string;
}
...
export const ClockChartComponent: React.FC<IClockChartProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>24-hour clock face chart</Caption1>}
          />
