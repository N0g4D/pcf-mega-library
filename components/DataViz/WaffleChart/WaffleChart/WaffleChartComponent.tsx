...
export interface IWaffleChartProps {
  value: string;
}
...
export const WaffleChartComponent: React.FC<IWaffleChartProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Waffle/unit chart for percentage visualization</Caption1>}
          />
