...
export interface ICalendarChartProps {
  value: string;
}
...
export const CalendarChartComponent: React.FC<ICalendarChartProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full-year calendar chart (GitHub-style)</Caption1>}
          />
