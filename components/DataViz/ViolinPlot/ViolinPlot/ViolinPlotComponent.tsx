...
export interface IViolinPlotProps {
  value: string;
}
...
export const ViolinPlotComponent: React.FC<IViolinPlotProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Violin plot for distribution comparison</Caption1>}
          />
