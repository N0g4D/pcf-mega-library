...
export interface IFlowDiagramProps {
  value: string;
}
...
export const FlowDiagramComponent: React.FC<IFlowDiagramProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Process flow diagram with swimlanes</Caption1>}
          />
