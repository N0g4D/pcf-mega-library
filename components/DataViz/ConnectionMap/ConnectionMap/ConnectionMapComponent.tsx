...
export interface IConnectionMapProps {
  value: string;
}
...
export const ConnectionMapComponent: React.FC<IConnectionMapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Connection/flight path map visualization</Caption1>}
          />
