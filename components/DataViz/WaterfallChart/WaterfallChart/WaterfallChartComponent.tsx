...
export const WaterfallChartComponent: React.FC<IWaterfallChartProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Waterfall chart showing incremental positive/negative values</Caption1>}
          />
