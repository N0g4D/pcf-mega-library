...
export interface IRidgePlotProps {
  value: string;
}
...
export const RidgePlotComponent: React.FC<IRidgePlotProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Ridge/joy plot for overlapping distributions</Caption1>}
          />
