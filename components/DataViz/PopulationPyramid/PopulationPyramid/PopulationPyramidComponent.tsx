...
export interface IPopulationPyramidProps {
  value: string;
}
...
export const PopulationPyramidComponent: React.FC<IPopulationPyramidProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Population pyramid chart</Caption1>}
          />
