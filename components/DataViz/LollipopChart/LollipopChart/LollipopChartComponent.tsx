...
export interface ILollipopChartProps {
  value: string;
}
...
export const LollipopChartComponent: React.FC<ILollipopChartProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Lollipop chart (dot + line) for ranked data</Caption1>}
          />
