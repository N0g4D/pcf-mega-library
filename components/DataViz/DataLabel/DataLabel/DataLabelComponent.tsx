...
export interface IDataLabelProps {
  value: string;
}
...
export const DataLabelComponent: React.FC<IDataLabelProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Formatted data label with unit and trend arrow</Caption1>}
          />
