...
export interface ILineChartAreaProps {
  value: string;
}
...
export const LineChartAreaComponent: React.FC<ILineChartAreaProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Area chart with gradient fill</Caption1>}
          />
