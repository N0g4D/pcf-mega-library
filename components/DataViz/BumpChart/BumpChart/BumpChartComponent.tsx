...
export interface IBumpChartProps {
  value: string;
}
...
export const BumpChartComponent: React.FC<IBumpChartProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Bump chart showing ranking changes over time</Caption1>}
          />
