...
export interface IDonutChartNestedProps {
  value: string;
}
...
export const DonutChartNestedComponent: React.FC<IDonutChartNestedProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Nested/multi-ring donut chart</Caption1>}
          />
