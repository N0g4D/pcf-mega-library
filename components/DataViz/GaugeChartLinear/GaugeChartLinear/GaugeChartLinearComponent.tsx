...
export interface IGaugeChartLinearProps {
  value: string;
}
...
export const GaugeChartLinearComponent: React.FC<IGaugeChartLinearProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Linear/horizontal gauge meter</Caption1>}
          />
