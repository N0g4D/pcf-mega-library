...
export interface IUnitConverterProps {
  value: string;
}
...
export const UnitConverterComponent: React.FC<IUnitConverterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Unit conversion tool (length, weight, temp, etc.)</Caption1>}
          />
