...
export interface IGUIDGeneratorProps {
  value: string;
}
...
export const GUIDGeneratorComponent: React.FC<IGUIDGeneratorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>GUID/UUID generator with copy</Caption1>}
          />
