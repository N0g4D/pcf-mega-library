...
export interface IBase64ToolProps {
  value: string;
}
...
export const Base64ToolComponent: React.FC<IBase64ToolProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Base64 encode/decode tool</Caption1>}
          />
