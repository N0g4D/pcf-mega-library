...
export interface ILoremGeneratorProps {
  value: string;
}
...
export const LoremGeneratorComponent: React.FC<ILoremGeneratorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Lorem ipsum placeholder text generator</Caption1>}
          />
