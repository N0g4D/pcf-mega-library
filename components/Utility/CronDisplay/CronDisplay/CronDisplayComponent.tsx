...
export interface ICronDisplayProps {
  value: string;
}
...
export const CronDisplayComponent: React.FC<ICronDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Cron expression human-readable display</Caption1>}
          />
