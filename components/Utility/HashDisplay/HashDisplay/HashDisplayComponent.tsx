...
export interface IHashDisplayProps {
  value: string;
}
...
export const HashDisplayComponent: React.FC<IHashDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Hash/checksum display for data integrity</Caption1>}
          />
