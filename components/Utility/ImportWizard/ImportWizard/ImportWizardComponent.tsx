...
export interface IImportWizardProps {
  value: string;
}
...
export const ImportWizardComponent: React.FC<IImportWizardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Data import wizard with preview and mapping</Caption1>}
          />
