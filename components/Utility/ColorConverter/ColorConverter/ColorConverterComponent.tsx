...
export interface IColorConverterProps {
  value: string;
}
...
export const ColorConverterComponent: React.FC<IColorConverterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Color format converter (hex, RGB, HSL)</Caption1>}
          />
