...
export interface IShortcutHelperProps {
  value: string;
}
...
export const ShortcutHelperComponent: React.FC<IShortcutHelperProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Keyboard shortcut cheat sheet overlay</Caption1>}
          />
