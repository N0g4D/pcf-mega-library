...
export interface IRegexTesterProps {
  value: string;
}
...
export const RegexTesterComponent: React.FC<IRegexTesterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Regex pattern tester with match highlighting</Caption1>}
          />
