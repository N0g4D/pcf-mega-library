...
export interface ILocaleDisplayProps {
  value: string;
}
...
export const LocaleDisplayComponent: React.FC<ILocaleDisplayProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Current locale and formatting info display</Caption1>}
          />
