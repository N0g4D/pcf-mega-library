...
export const ChangePasswordComponent: React.FC<IChangePasswordProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Change password form with current password verification</Caption1>}
          />
