...
export interface ILoginFormMFAProps {
  value: string;
}
...
export const LoginFormMFAComponent: React.FC<ILoginFormMFAProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Login form with MFA/2FA step</Caption1>}
          />
