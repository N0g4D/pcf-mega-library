...
export interface ILoginFormSocialProps {
  value: string;
}
...
export const LoginFormSocialComponent: React.FC<ILoginFormSocialProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Login form with social provider buttons</Caption1>}
          />
