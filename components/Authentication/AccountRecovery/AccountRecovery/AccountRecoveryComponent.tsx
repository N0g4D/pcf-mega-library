...
export interface IAccountRecoveryProps {
  value: string;
}
...
export const AccountRecoveryComponent: React.FC<IAccountRecoveryProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Account recovery options display</Caption1>}
          />
