...
export const ConsentCheckboxComponent: React.FC<IConsentCheckboxProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Terms and conditions consent checkbox with link</Caption1>}
          />
