...
export interface IPasskeyPromptProps {
  value: string;
}
...
export const PasskeyPromptComponent: React.FC<IPasskeyPromptProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Passkey/FIDO2 authentication prompt</Caption1>}
          />
