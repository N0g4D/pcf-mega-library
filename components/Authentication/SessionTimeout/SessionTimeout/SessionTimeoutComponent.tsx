...
export const SessionTimeoutComponent: React.FC<ISessionTimeoutProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Session timeout warning dialog with extend option</Caption1>}
          />
