...
export const OrganizationSwitcherComponent: React.FC<IOrganizationSwitcherProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Organization/tenant switcher dropdown</Caption1>}
          />
