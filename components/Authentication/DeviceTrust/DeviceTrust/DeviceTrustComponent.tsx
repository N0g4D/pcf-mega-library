...
export interface IDeviceTrustProps {
  value: string;
}
...
export const DeviceTrustComponent: React.FC<IDeviceTrustProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Trusted device management list</Caption1>}
          />
