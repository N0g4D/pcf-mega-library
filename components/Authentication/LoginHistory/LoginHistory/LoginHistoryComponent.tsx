...
export interface ILoginHistoryProps {
  value: string;
}
...
export const LoginHistoryComponent: React.FC<ILoginHistoryProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Login history/audit log display</Caption1>}
          />
