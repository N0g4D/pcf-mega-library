...
export interface IDataGridColumnChooserProps {
  value: string;
}
...
export const DataGridColumnChooserComponent: React.FC<IDataGridColumnChooserProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grid with show/hide column picker panel</Caption1>}
          />
