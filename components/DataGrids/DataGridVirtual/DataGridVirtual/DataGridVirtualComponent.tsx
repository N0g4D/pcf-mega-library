...
export interface IDataGridVirtualProps {
  value: string;
}
...
export const DataGridVirtualComponent: React.FC<IDataGridVirtualProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Virtualized data grid for 100K+ rows</Caption1>}
          />
