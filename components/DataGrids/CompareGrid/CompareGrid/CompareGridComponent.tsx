...
export interface ICompareGridProps {
  value: string;
}
...
export const CompareGridComponent: React.FC<ICompareGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Side-by-side comparison grid (2-4 items)</Caption1>}
          />
