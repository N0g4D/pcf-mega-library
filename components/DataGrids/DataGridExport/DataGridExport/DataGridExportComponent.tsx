...
export interface IDataGridExportProps {
  value: string;
}
...
export const DataGridExportComponent: React.FC<IDataGridExportProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Data grid with CSV/Excel/PDF export</Caption1>}
          />
