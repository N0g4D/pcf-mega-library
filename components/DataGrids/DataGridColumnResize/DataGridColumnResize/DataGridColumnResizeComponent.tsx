...
export interface IDataGridColumnResizeProps {
  value: string;
}
...
export const DataGridColumnResizeComponent: React.FC<IDataGridColumnResizeProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grid with smooth column resize handles</Caption1>}
          />
