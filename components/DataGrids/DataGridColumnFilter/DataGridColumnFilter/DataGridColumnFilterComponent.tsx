...
export const DataGridColumnFilterComponent: React.FC<IDataGridColumnFilterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Per-column filter dropdowns in header</Caption1>}
          />
