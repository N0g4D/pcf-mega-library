...
export interface IDataGridCRUDProps {
  value: string;
}
...
export const DataGridCRUDComponent: React.FC<IDataGridCRUDProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full CRUD data grid with add/edit/delete</Caption1>}
          />
