...
export interface IDataGridGalleryProps {
  value: string;
}
...
export const DataGridGalleryComponent: React.FC<IDataGridGalleryProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grid with gallery/image column renderer</Caption1>}
          />
