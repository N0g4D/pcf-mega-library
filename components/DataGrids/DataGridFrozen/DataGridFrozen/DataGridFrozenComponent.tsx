...
export interface IDataGridFrozenProps {
  value: string;
}
...
export const DataGridFrozenComponent: React.FC<IDataGridFrozenProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Data grid with frozen columns and rows</Caption1>}
          />
