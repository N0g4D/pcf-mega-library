...
export interface IDataGridInfiniteProps {
  value: string;
}
...
export const DataGridInfiniteComponent: React.FC<IDataGridInfiniteProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grid with infinite scroll loading</Caption1>}
          />
