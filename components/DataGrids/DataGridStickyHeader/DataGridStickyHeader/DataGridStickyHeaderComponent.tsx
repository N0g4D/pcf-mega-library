...
export interface IDataGridStickyHeaderProps {
  value: string;
}
...
export const DataGridStickyHeaderComponent: React.FC<IDataGridStickyHeaderProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grid with sticky header on scroll</Caption1>}
          />
