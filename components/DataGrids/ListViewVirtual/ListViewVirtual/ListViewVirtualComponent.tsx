...
export interface IListViewVirtualProps {
  value: string;
}
...
export const ListViewVirtualComponent: React.FC<IListViewVirtualProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Virtualized list for massive datasets</Caption1>}
          />
