...
export const DataGridComponent: React.FC<IDataGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Full-featured data grid with sorting, filtering, and pagination</Caption1>}
          />
