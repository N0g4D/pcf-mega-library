...
export interface IDataGridTreeProps {
  value: string;
}
...
export const DataGridTreeComponent: React.FC<IDataGridTreeProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Tree data grid with expandable parent-child rows</Caption1>}
          />
