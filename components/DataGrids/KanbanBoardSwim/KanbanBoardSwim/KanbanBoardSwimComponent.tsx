...
export interface IKanbanBoardSwimProps {
  value: string;
}
...
export const KanbanBoardSwimComponent: React.FC<IKanbanBoardSwimProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Kanban with swimlanes for categories</Caption1>}
          />
