...
export interface IListViewGroupedProps {
  value: string;
}
...
export const ListViewGroupedComponent: React.FC<IListViewGroupedProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Grouped list with collapsible sections</Caption1>}
          />
