...
export interface IMatrixGridProps {
  value: string;
}
...
export const MatrixGridComponent: React.FC<IMatrixGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Row-column intersection matrix editor</Caption1>}
          />
