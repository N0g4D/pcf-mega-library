...
export interface ILikertScaleProps {
  value: string;
}
...
export const LikertScaleComponent: React.FC<ILikertScaleProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Likert scale input for surveys</Caption1>}
          />
