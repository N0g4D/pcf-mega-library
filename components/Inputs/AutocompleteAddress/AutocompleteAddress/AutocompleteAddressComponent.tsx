...
export const AutocompleteAddressComponent: React.FC<IAutocompleteAddressProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Auto-completing address input with validation</Caption1>}
          />
