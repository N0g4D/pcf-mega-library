...
export interface ILikeDislikeProps {
  value: string;
}
...
export const LikeDislikeComponent: React.FC<ILikeDislikeProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Thumbs up/down binary feedback input</Caption1>}
          />
