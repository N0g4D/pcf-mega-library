...
export const QuantityStepperComponent: React.FC<IQuantityStepperProps> = ({ value, min, max, step, size, disabled }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Compact quantity selector with +/- buttons</Caption1>}
          />
        </Card>
      </div>
    </FluentProvider>
