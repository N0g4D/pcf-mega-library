...
export interface ITagInputDraggableProps {
  value: string;
}
...
export const TagInputDraggableComponent: React.FC<ITagInputDraggableProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Tag input with drag-to-reorder</Caption1>}
          />
