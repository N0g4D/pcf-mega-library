...
export interface ITextAreaRichProps {
  value: string;
}
...
export const TextAreaRichComponent: React.FC<ITextAreaRichProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Rich text editor with toolbar (bold, italic, links)</Caption1>}
          />
