...
export interface IBudgetInputProps {
  value: string;
}
...
export const BudgetInputComponent: React.FC<IBudgetInputProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Budget range input with visual bar</Caption1>}
          />
