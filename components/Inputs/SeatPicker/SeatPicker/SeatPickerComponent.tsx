...
export interface ISeatPickerProps {
  value: string;
}
...
export const SeatPickerComponent: React.FC<ISeatPickerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Visual seat/position picker</Caption1>}
          />
