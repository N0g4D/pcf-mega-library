...
export interface ICronEditorProps {
  value: string;
}
...
export const CronEditorComponent: React.FC<ICronEditorProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Visual cron expression builder</Caption1>}
          />
