...
export interface ISliderInputVerticalProps {
  value: string;
}
...
export const SliderInputVerticalComponent: React.FC<ISliderInputVerticalProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Vertical orientation slider</Caption1>}
          />
