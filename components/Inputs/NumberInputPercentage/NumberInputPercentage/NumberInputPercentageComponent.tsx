...
export interface INumberInputPercentageProps {
  value: string;
}
...
export const NumberInputPercentageComponent: React.FC<INumberInputPercentageProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Percentage input with visual indicator</Caption1>}
          />
