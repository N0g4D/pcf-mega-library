...
export interface ISliderRatingProps {
  value: string;
}
...
export const SliderRatingComponent: React.FC<ISliderRatingProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Slider-based satisfaction rating (1-10)</Caption1>}
          />
