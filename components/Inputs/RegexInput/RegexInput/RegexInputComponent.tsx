...
export interface IRegexInputProps {
  value: string;
}
...
export const RegexInputComponent: React.FC<IRegexInputProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Regex builder with live match preview</Caption1>}
          />
