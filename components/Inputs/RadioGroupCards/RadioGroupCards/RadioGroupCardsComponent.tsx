...
export interface IRadioGroupCardsProps {
  value: string;
}
...
export const RadioGroupCardsComponent: React.FC<IRadioGroupCardsProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Radio selection with card-style options</Caption1>}
          />
