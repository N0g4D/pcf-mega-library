...
export interface ISmartLookupProps {
  value: string;
}
...
export const SmartLookupComponent: React.FC<ISmartLookupProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Smart lookup with recent, suggested, and search tabs</Caption1>}
          />
