...
export interface IFileUploadMultiProps {
  value: string;
}
...
export const FileUploadMultiComponent: React.FC<IFileUploadMultiProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Multi-file upload with queue management</Caption1>}
          />
