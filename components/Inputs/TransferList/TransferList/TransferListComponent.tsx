...
export const TransferListComponent: React.FC<ITransferListProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Dual-list transfer component with search and reorder</Caption1>}
          />
