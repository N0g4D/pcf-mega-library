...
export interface IFormNPSProps {
  value: string;
}
...
export const FormNPSComponent: React.FC<IFormNPSProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Net Promoter Score (0-10) question</Caption1>}
          />
