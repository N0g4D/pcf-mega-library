...
export interface IFormProgressProps {
  value: string;
}
...
export const FormProgressComponent: React.FC<IFormProgressProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Form completion progress indicator</Caption1>}
          />
