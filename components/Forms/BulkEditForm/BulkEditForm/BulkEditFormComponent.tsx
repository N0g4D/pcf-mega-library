...
export interface IBulkEditFormProps {
  value: string;
}
...
export const BulkEditFormComponent: React.FC<IBulkEditFormProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Bulk edit form for multiple records</Caption1>}
          />
