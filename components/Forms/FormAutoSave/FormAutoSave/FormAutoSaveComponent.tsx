...
export interface IFormAutoSaveProps {
  value: string;
}
...
export const FormAutoSaveComponent: React.FC<IFormAutoSaveProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Auto-saving form with status indicator</Caption1>}
          />
