...
export interface IFormRepeaterProps {
  value: string;
}
...
export const FormRepeaterComponent: React.FC<IFormRepeaterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Repeatable field group (add/remove rows)</Caption1>}
          />
