...
export interface IStatusReasonProps {
  value: string;
}
...
export const StatusReasonComponent: React.FC<IStatusReasonProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Status/status-reason transition selector</Caption1>}
          />
