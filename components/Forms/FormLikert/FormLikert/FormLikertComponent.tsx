...
export interface IFormLikertProps {
  value: string;
}
...
export const FormLikertComponent: React.FC<IFormLikertProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Likert scale survey question</Caption1>}
          />
