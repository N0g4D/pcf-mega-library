...
export interface IFormMatrixProps {
  value: string;
}
...
export const FormMatrixComponent: React.FC<IFormMatrixProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Matrix-style question form (rows x columns)</Caption1>}
          />
