...
export interface IInlineEditDateProps {
  value: string;
}
...
export const InlineEditDateComponent: React.FC<IInlineEditDateProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Click-to-edit inline date field</Caption1>}
          />
