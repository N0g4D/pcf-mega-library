...
export interface IQuickCreateFormProps {
  value: string;
}
...
export const QuickCreateFormComponent: React.FC<IQuickCreateFormProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Minimal quick-create form in a dialog</Caption1>}
          />
