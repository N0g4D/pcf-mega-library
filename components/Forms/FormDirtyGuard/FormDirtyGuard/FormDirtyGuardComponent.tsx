...
export interface IFormDirtyGuardProps {
  value: string;
}
...
export const FormDirtyGuardComponent: React.FC<IFormDirtyGuardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Unsaved changes warning guard</Caption1>}
          />
