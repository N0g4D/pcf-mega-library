...
export interface IFormRatingProps {
  value: string;
}
...
export const FormRatingComponent: React.FC<IFormRatingProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Rating question with multiple criteria</Caption1>}
          />
