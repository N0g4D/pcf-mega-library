...
export interface IPointsCounterProps {
  value: string;
}
...
export const PointsCounterComponent: React.FC<IPointsCounterProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Animated points/score counter</Caption1>}
          />
