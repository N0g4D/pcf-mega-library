...
export interface IDailyRewardProps {
  value: string;
}
...
export const DailyRewardComponent: React.FC<IDailyRewardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Daily reward calendar with claim tracking</Caption1>}
          />
