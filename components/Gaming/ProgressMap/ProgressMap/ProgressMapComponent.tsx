...
export interface IProgressMapProps {
  value: string;
}
...
export const ProgressMapComponent: React.FC<IProgressMapProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Visual progress map/journey with milestones</Caption1>}
          />
