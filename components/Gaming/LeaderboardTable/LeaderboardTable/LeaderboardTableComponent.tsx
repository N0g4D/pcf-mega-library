...
export const LeaderboardTableComponent: React.FC<ILeaderboardTableProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Ranked leaderboard table with avatars and stats</Caption1>}
          />
