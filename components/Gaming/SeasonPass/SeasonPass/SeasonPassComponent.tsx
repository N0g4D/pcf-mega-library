...
export interface ISeasonPassProps {
  value: string;
}
...
export const SeasonPassComponent: React.FC<ISeasonPassProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Season pass tier progress display</Caption1>}
          />
