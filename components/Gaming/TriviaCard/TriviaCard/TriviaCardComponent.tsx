...
export interface ITriviaCardProps {
  value: string;
}
...
export const TriviaCardComponent: React.FC<ITriviaCardProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Trivia/quiz question card with timer</Caption1>}
          />
