...
export interface IInventoryGridProps {
  value: string;
}
...
export const InventoryGridComponent: React.FC<IInventoryGridProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Inventory/collection grid with slots</Caption1>}
          />
