...
export interface IQuestTrackerProps {
  value: string;
}
...
export const QuestTrackerComponent: React.FC<IQuestTrackerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Quest/challenge tracker with objectives</Caption1>}
          />
