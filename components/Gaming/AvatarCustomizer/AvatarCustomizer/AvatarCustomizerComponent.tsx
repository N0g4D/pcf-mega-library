...
export interface IAvatarCustomizerProps {
  value: string;
}
...
export const AvatarCustomizerComponent: React.FC<IAvatarCustomizerProps> = ({ value }) => {
      ...
      <div className={classes.root}>
        <Card className={classes.card}>
          <CardHeader
            ...
            description={<Caption1>Character/avatar customization panel</Caption1>}
          />
